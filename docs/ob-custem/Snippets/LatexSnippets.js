[
	// 微分符号dx
	{trigger: "dx", replacement: "\\mathrm{d}x", options: "mA"},
	// 逻辑符号：任意、存在
	{trigger: "renyi", replacement: "\\forall", options: "mA"},
	{trigger: "cunzai", replacement: "\\exists", options: "mA"},
